package com.resenias.resenias.model;
...
public class Resenia {
    ...
    // Referencia al usuario en ms-usuarios (sin FK real entre microservicios)
    @NotNull(message = "El ID de usuario es obligatorio")
    @Column(name = "usuario_id", nullable = false)
    private Integer usuarioId;

    // Referencia al restaurante en ms-restaurantes (sin FK real entre microservicios)
